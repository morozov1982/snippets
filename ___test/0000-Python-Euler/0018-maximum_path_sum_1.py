...
## Примечание:
## Так как в данном треугольнике всего 16384 возможных маршрута
## от вершины до основания, эту задачу можно решить
## проверяя каждый из маршрутов.
...
for row in triangle_tuple1[::-1]:
    for col in range(len(row)):
        a = triangle_tuple1[row][col]
        b = 0
