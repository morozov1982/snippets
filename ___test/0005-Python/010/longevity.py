...
class Application(Frame):
    ...
    def create_widgets(self):
        """ Создаём кнопку, текстовое поле и текстовую область. """
        # метка-инструкция
        ...
        self.sunmit_bttn = Button(self, text="Узнать секрет", command=self.reveal)
        self.sunmit_bttn.grid(row=2, column=0, sticky=W)

        # создание текстовой области, в которую будет введён ответ
